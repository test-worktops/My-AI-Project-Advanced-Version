...
const JobWizardLayout = ({ variant, validation, progressBar }) => {
        ...
        <>
            ...
            >
                ...
                <Card.Body className="fw-normal px-md-6 py-4">
                    ...
                    {step === 1 && (
                        <AddJobsForm register={register} errors={errors} watch={watch} />
                    )}
                </Card.Body>
            </Card>
        </>
...
export default JobWizardLayout;
