...
import BillingForm from 'components/wizard/BillingForm';
...
import SellerPersonalForm from './SellerPersonalForm';
import SellerBillingUserForm from './SellerBillingForm';

const SellerWizardLayout = ({ variant, validation, progressBar }) => {
    ...
    <>
      ...
      >
        ...
        <Card.Body className="fw-normal px-md-6 py-4">
          ...
          {step === 1 && (
            <SellerAccountForm register={register} errors={errors} watch={watch} />
          )}
          {step === 2 && (
            <SellerPersonalForm
              register={register}
...
export default SellerWizardLayout;
