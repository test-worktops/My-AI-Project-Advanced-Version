    ...
    //   children: [
        ...
        },
        {
          ...
          children: [
            {
              name: 'All Products',
              to: '/dashboard/product/all-products',
              active: true
            },
            // {
            //   name: 'Product grid',
            ...
            {
              name: 'Edit Product',
              to: '/dashboard/product/edit-product',
              active: true
            },
          ]
        },
        {
          ...
          children: [
            {
              name: 'All Freelancer',
              to: '/dashboard/Freelancer/all-freelancer',
              active: true
            },
            {
              name: 'Add Freelancer',
              to: '/dashboard/Freelancer/add-freelancer',
              active: true
            }
          ]
        },
        {
          ...
          children: [
            {
              name: 'All Orders',
              to: '/e-commerce/orders/all-orders',
              active: true
            }
          ]
        },
        {
          ...
          children: [
            {
              name: 'All Services',
              to: '/e-commerce/services/all-services',
              active: true
            },
            {
              name: 'Add Services',
              to: '/e-commerce/services/add-services',
              active: true
            }
          ]
        },
        {
          ...
          children: [
            {
              name: 'All Jobs',
              to: '/e-commerce/jobs/all-jobs',
              active: true
            },
            {
              name: 'Add Jobs',
              to: '/e-commerce/jobs/add-jobs',
              active: true
            }
          ]
        },
          ...
          children: [
            {
              ...
              to: '/e-commerce/commission/service-commission',
              active: true
            },
            {
              name: 'All Category Commission',
              active: true,
              children: [
                {
                  name: 'Category Commission',
                  to: '/e-commerce/commission/category-commission',
                  active: true
                }]
            },
            {
              name: 'All Freelancer Commission',
              active: true,
              children: [
                {
                  name: 'Freelancer Commission',
                  to: '/e-commerce/commission/freelancer-commission',
                  active: true
                }]
            },
            {
              name: 'Global Commission',
              to: '/e-commerce/commission/global-commission',
              active: true
            },
        //   ]
        // },
...
export const pagesRoutes = {
  ...
  children: [
    ...
    //         {
    //           name:'Seller Sign Up',
    //           to:'/authentication/simple/seller-sign-up',
    //           active:true
    //         },
    //         {
    //           name:'Seller SignUp Wizard',
    //           to:'/authentication/simple/seller-sign-up-wizard',
    //           active:true
    //         },
    //         {
    //           name:'Project Owner Sign Up',
    //           to:'/authentication/simple/project-owner-sign-up',
    //           active:true
    //         },
    //         {
    ...
    //         {
    //           name: 'Admin Login',
    //           to: 'authentication/card/adminlogin',
    //           active: true
    //         },
    //         {
    //           name: 'Staff Login',
    //           to: 'authentication/card/stafflogin',
    //           active: true
    //         },
    //         {
    //           name: 'Logout',
