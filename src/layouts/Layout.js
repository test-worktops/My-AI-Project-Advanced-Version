...
import SellerWizard from 'Mai Components/SellerSignUp/SellerWizard';
...
import AddProduct from 'Mai Components/product-details/AddProduct';
// import AddProduct from 'components/app/e-commerce/product/product-details/AddProduct';
import EditProduct from 'Mai Components/product-details/EditProduct';
import AllProducts from 'Mai Components/product-details/AllProducts';
// import AllProducts from 'components/app/e-commerce/product/product-details/AllProducts';
// import AddFreelancer from 'components/app/e-commerce/Freelancer/AddFreelancer';
import AddFreelancer from 'Mai Components/Freelancer/AddFreelancer';
import AllFreelancer from 'Mai Components/Freelancer/AllFreelancer';
// import AllFreelancer from 'components/app/e-commerce/Freelancer/AllFreelancer';
import SellerSignUp from '../Mai Components/SellerSignUp/SellerSignup';
import ProjectOwnerSignup from 'components/authentication/simple/ProjectOwnerSignup';
import SellerSignUpWizard from 'Mai Components/SellerSignUpWizard';
import SellerWizardAuth from 'Mai Components/SellerSignUp/SellerWizardAuth';
import AllServices from 'Mai Components/Services/AllServices';
import AddServices from 'Mai Components/Services/AddServices';
import Alljob from 'Mai Components/Jobs/AllJob';
import AddJobs from 'Mai Components/Jobs/AddJobs';
import Userlogin from 'Mai Components/UserPortal/Userlogin';
import FrontendRegisterForm from 'components/authentication/simple/FrontendRegisterForm';
  ...
  return (
    <>
      <Routes>
        ...
        <Route
          path='/authentication/simple/seller-sign-up'
          element={<SellerSignUp />}
        />
        <Route
          path='/authentication/simple/project-owner-sign-up'
          element={<ProjectOwnerSignup />}
        />
        <Route path='/authentication/simple/seller-sign-up-wizard'
          element={<SellerSignUpWizard />}
        />
        {/*- ------------- Card ---------------------------  */}
        ...
        />
        <Route element={<SellerWizardAuth />}>
          <Route
            path="authentication/seller-wizard"
            element={<SellerWizard validation={true} />}
          />
        </Route>
        ...
        <Route element={<MainLayout />}>
          ...
          />
          <Route
            path='dashboard/product/all-products'
            element={<AllProducts />}
          />
          {/* Ai Project- Dashboard/Product */}

          {/* Ai Project- Dashboard/Freelancer */}

          <Route
            path='dashboard/Freelancer/add-freelancer'
            element={<AddFreelancer />}
          />
          <Route
            path='dashboard/Freelancer/all-freelancer'
            element={<AllFreelancer />}
          />
          {/* Ai Project- Dashboard/Freelancer */}

          {/* Ai Project- Dashboard/Services */}
          <Route path='/e-commerce/services/all-services'
            element={<AllServices />}
          />
          <Route path='/e-commerce/services/add-services'
            element={<AddServices />}
          />
          {/* Ai Project- Dashboard/Services */}

          {/* Ai Project- Dashboard/Jobs */}
          <Route path='/e-commerce/jobs/all-jobs'
            element={<Alljob />}
          />
          <Route path='/e-commerce/jobs/add-jobs'
            element={<AddJobs />}
          />
          ...
          {/* Ai Project- User-Login */}
          <Route path='authentication/card/adminlogin'
            element={<AdminPanelLoginForm />}
          />
          <Route path='authentication/card/stafflogin'
            element={<Userlogin />}
          />

          {/* Ai Project- User-Login */}

          {/* Ai Project- RegisterForm*/}
          <Route path='/user-portal/user-register'
          element={<FrontendRegisterForm/>}
          />
          {/* Ai Project- RegisterForm*/}
